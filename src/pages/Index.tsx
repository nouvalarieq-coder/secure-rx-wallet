    ...
    <Layout>
        ...
        <div className="container py-16 md:py-24 grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <p className="mt-5 text-lg text-muted-foreground max-w-xl">
              MediCryp menghadirkan marketplace obat resmi BPOM dengan opsi bayar fiat
      ...
      <section className="container py-16 md:py-20">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="mt-3 text-muted-foreground">Tiga langkah mudah berbelanja obat dengan MediCryp.</p>
        </div>
